...
#import "DP_AppDelegate.h"
#import "DP_ProjectsTableViewController.h"

#import <AFNetworkActivityIndicatorManager.h>

@implementation DP_AppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    DP_ProjectsTableViewController *addProjectVC = [[DP_ProjectsTableViewController alloc] initWithNibName:@"DP_ProjectsTableViewController" bundle:nil];
    UINavigationController *addProjectNavC = [[UINavigationController alloc] initWithRootViewController:addProjectVC];
    
    self.window.rootViewController = addProjectNavC;
